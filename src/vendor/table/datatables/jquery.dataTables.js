...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "Nenhuma registros para mostrar"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoFiltered": " - registros _MAX_ "
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoFiltered": "(encontrado _MAX_ registros)",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoPostFix": "Todos os registros mostrados são derivados de informações reais."
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "processing": "DataTables está atualmente ocupado"
			 *        }
			 *      } );
			 *    } );
			 */
